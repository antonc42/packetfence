...
image::docs/images/pfaerohive16.png[scaledwidth="100%",alt="SSID configuration"]
...
image::docs/images/pfaerohive15.png[scaledwidth="100%",alt="External portal SSID configuration"]
...
image::docs/images/pfaerohive17.png[scaledwidth="100%",alt="Radius configuration"]
...
image::docs/images/pfaerohive18.png[scaledwidth="100%",alt="CoA configuration"]

* click on the Save button

Configure the User profile:

image::docs/images/pfaerohive19.png[scaledwidth="100%",alt="CoA configuration"]

* under _User Profile_ , click on *Add/Remove* and click on New

image::docs/images/pfaerohive20.png[scaledwidth="100%",alt="User Profile configuration"]
...
image::docs/images/pfaerohive21.png[scaledwidth="100%",alt="vlan configuration"]
